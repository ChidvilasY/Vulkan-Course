	...
	void* userData)
{
	...
	// If validation information, then output information and return okay
	if (flags & VK_DEBUG_REPORT_INFORMATION_BIT_EXT)
	{
		printf("VALIDATION INFORMATION: %s\n", message);
		return VK_FALSE;
	}
...
static VKAPI_ATTR VkBool32 VKAPI_CALL DebugMessengerContextCallBack(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
